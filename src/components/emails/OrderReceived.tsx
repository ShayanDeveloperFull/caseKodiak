      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            <Img
              src={`${baseUrl}/WebLogo3.png`}
              width="65"
              height="73"
              style={{ margin: "auto" }}
            />
            <Heading style={global.heading}>Thank you for your oder!</Heading>
            <Text style={global.text}>
              We're preparing everything for delivery and we will notify when
          ...
          <Section style={paddingY}>
            ...
            <Row>
              <Text style={footer.text}>
                © caseKodiak, Inc. All Rights Reserved.
              </Text>
            </Row>
          </Section>
        </Container>
