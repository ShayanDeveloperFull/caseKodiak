...
export default function DesignPreview({
  ...
  return (
    <>
      ...
      >
        <div
          className="sm:col-span-4 md:col-span-3 md:row-span-2 
        md:row-end-2"
        >
          <Phone
            className={cn(`bg-${tw}`)}
          ...
          >
            <div>
              ...
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                <li>Custom-designed artwork made</li>
                <li>Military-grade drop protection</li>
                <li>Ultra-slim design without bulk</li>
                <li>Scratch-resistant, fade-resistant finish</li>
              </ol>
            </div>
            <div>
              <p className="font-medium text-zinc-950">Materials</p>
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                <li>Dual-layer impact-absorbing TPU core</li>
                <li>Scratch-resistant matte coating</li>
                <li>Fade-resistant HD print</li>
              </ol>
            </div>
          </div>
